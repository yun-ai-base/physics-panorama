...
export const UI_LABELS = {
  zh: {
    ...
    favEmpty: '还没有收藏。打开任意节点，点「☆ 收藏」即可加入。',
    searchNoMatch: '无匹配',
    addFavorite: '☆ 收藏',
    addedFavorite: '★ 已收藏',
    highlightPath: '高亮此路径',
    ...
    back: '返回',
    myNoteLabel: '📝 我的笔记（仅存于本机浏览器）',
    notePlaceholder: '写下你对这个节点的理解…',
  ...
  en: {
    ...
    favEmpty: 'No favorites yet. Open any node and click ☆ to add.',
    ...
    back: 'Back',
    myNoteLabel: '📝 My note (stored locally)',
    notePlaceholder: 'Write your understanding of this node…',
