...
import { EXPERIMENTS } from './data/experiments.js?v=20260911-9d1f4e';
import { ERAS, ERA_ORDER, UI_LABELS } from './config.js?v=20260911-9d1f4e';
import { state } from './state.js?v=20260911-9d1f4e';
import { esc } from './utils.js?v=20260911-9d1f4e';
import { portraitName, personNameEn } from './data/portraitMap.js?v=20260911-9d1f4e';
